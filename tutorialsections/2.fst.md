...
odgi extract -i <(zcat chr15.pan.fa.a2fb268.4030258.6a1ecc2.smooth.og.gz ) \
    -r chm13#chr15:53000001-53020000 -t 8 -P -o - \
...
![chr15 53mbp bandage](../img/chr15_53000001-53020000.bandage.zoom.png)
...
```bash
odgi extract -i <(zcat chr15.pan.fa.a2fb268.4030258.6a1ecc2.smooth.og.gz ) \
    -r chm13#chr15:66080001-66090000 -t 8 -P -o - \
...
```bash
odgi extract -i <(zcat chr15.pan.fa.a2fb268.4030258.6a1ecc2.smooth.og.gz ) -r chm13#chr15:77970001-84980000 -d 5000000 -t 8 -P -o - \
