...
```
This is **a pangenome issue** because the VCF format was not conceived to contain al the information of pangenome graphs.
...
## --out  note that we do not need to specify file extension 
```
